...
const projects = [
  ...
  { key:'moto', name:'GEAR UP', desc:'Budujemy społeczność motoryzacyjną, zloty i akcesoria (wkrótce).', url:null },
  { key:'detail', name:'GUT GARAGE', desc:'Detailing / ochrona lakieru — start w przygotowaniu.', url:null },
];
